...
class Answer:
    def __init__(self, name: str, type_record: str, class_record: str, ttl_sec: int, rdata: RecordTypeA or RecordTypeAAAA or RecordTypeNS or RecordTypePTR or RecordTypeSoa or RecordTypeMX):
        self._Name = name
