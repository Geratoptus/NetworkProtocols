...
class DNSParser:
    def __init__(self, bytes_stream: bytes):
        ...
        self._id = convert_to_read((bytes_for_header[START_ID: END_ID]))
        self._QR = convert_to_read(bytes_for_header[START_END_QR])
        self._op_code = convert_to_read(bytes_for_header[START_OPCODE:END_OPCODE])
        self._AA = convert_to_read(bytes_for_header[START_END_AA])
        self._TC = convert_to_read(bytes_for_header[START_END_TC])
        self._RD = convert_to_read(bytes_for_header[START_END_RD])
        self._RA = convert_to_read(bytes_for_header[START_END_RA])
        self._Z = convert_to_read(bytes_for_header[START_RESERVED_BITS: END_RESERVED_BITS])
        self._RCODE = convert_to_read(bytes_for_header[START_RCODE: END_RCODE])
        self._QDCOUNT = convert_to_read(
            bytes_for_header[START_QDCOUNT: END_QDCOUNT])
        self._ANCOUNT = convert_to_read(
            bytes_for_header[START_ANCOUNT: END_ANCOUNT])
        self._NSCOUNT = convert_to_read(
            bytes_for_header[START_NSCOUNT: END_NSCOUNT])
        self._ARCOUNT = convert_to_read(
            bytes_for_header[START_ARCOUNT: END_ARCOUNT])
